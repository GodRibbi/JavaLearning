...
public class DataAccessor {
    ...
    static final String DB_URL = "jdbc:mysql://localhost:3306/zrq?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC";

    // 数据库的用户名与密码，需要根据自己的设置
    static final String USER = "root";
    static final String PASS = "111111";

    public Map<String, List> getSong(String sql) {
    ...
    public Map<String, List> getAlbum(String sql) {
        Connection conn = null;
        Statement stmt = null;
        Map<String, List> data = new HashMap<>();
        List<String> albumidlist = new LinkedList<>();
    ...
    public Map<String, List> getRegion(String sql) {
        Connection conn = null;
        Statement stmt = null;
        Map<String, List> data = new HashMap<>();
    ...
    public static Map<String, List> getData(String sql) {
        Connection conn = null;
        Statement stmt = null;
        Map<String, List> data = new HashMap<>();
        //List<String> songidlist = new LinkedList<>();
